...
public class App {
    public static void main(String[] args) {
        ...
        do {
            // el (i + 1) es para sumar 1 a i y que aparezca en pantalla en numero entendible
            ...
            switch (choice) {
                ...
                case 3:
                    ...
                    Double baseT = keyboard.nextDouble();
                    // instancio la clase con el constructor con paranetros
                    Triangle t = new Triangle(heigthT, baseT);
                    figures.add(t);
                    i++;
                    break;
                default:
